...
GRANT `Chef` TO 'chef2'@'localhost';
GRANT `Chef` TO 'chef3'@'localhost';


SET DEFAULT ROLE `Chef` TO 'chef2'@'localhost';
SET DEFAULT ROLE `Chef` TO 'chef3'@'localhost';
...
BEGIN
    ...
    -- show the rec_ings table
        SELECT ri.REC_ID, i.Name, ri.ING_ID, ri.Precise_Quantity, ri.Inprecise_Quantity 
        FROM rec_ingr ri JOIN ingredients i ON ri.ING_ID=i.ING_ID 
