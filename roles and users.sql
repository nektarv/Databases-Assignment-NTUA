...
GRANT ALL PRIVILEGES ON `im already dead`.* TO `Admin`;
...
-- Grant view access to Chef role
GRANT SELECT ON `im already dead`.`personal_info` TO `Chef`;
GRANT SELECT ON `im already dead`.`episodes_played` TO `Chef`;
GRANT SELECT ON `im already dead`.`chefs_recipes` TO `Chef`;
...
GRANT EXECUTE ON PROCEDURE `im already dead`.get_personal_info TO 'chef3'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.update_personal_info TO 'chef3'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.get_personal_info TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.update_personal_info TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.get_episodes_played TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.get_episodes_played TO 'chef3'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.get_chefs_recipes TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.get_chefs_recipes TO 'chef3'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.update_recipe TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.update_recipe TO 'chef3'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.add_recipe TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.add_recipe TO 'chef3'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.get_recipe_steps TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.get_recipe_steps TO 'chef3'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.delete_recipe_step TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.delete_recipe_step TO 'chef3'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.add_step TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.add_step TO 'chef3'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.get_recipe_ingredients TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.get_recipe_ingredients TO 'chef3'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.delete_recipe_ingredient TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.delete_recipe_ingredient TO 'chef3'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.add_ingredient TO 'chef2'@'localhost';
GRANT EXECUTE ON PROCEDURE `im already dead`.add_ingredient TO 'chef3'@'localhost';
